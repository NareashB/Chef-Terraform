# -*- encoding: utf-8 -*-
# stub: kitchen-digitalocean 0.9.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<test-kitchen>.freeze, ["~> 1.17"])
      s.add_runtime_dependency(%q<droplet_kit>.freeze, ["~> 2.2"])
      ...
      s.add_dependency(%q<test-kitchen>.freeze, ["~> 1.17"])
      s.add_dependency(%q<droplet_kit>.freeze, ["~> 2.2"])
