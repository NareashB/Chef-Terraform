# -*- encoding: utf-8 -*-
# stub: test-kitchen 1.20.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<winrm-fs>.freeze, ["~> 1.1.0"])
      ...
      s.add_development_dependency(%q<minitest>.freeze, ["< 5.11", "~> 5.3"])
      ...
      s.add_dependency(%q<winrm-fs>.freeze, ["~> 1.1.0"])
      ...
      s.add_dependency(%q<minitest>.freeze, ["< 5.11", "~> 5.3"])
