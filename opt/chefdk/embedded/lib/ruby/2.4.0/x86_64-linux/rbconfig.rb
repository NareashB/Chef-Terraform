...
module RbConfig
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib  -Wl,-rpath,/opt/chefdk/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/chefdk/embedded/lib -L/opt/chefdk/embedded/lib -fstack-protector -rdynamic -Wl,-export-dynamic -L/opt/chefdk/embedded/lib  -Wl,-rpath,/opt/chefdk/embedded/lib"
